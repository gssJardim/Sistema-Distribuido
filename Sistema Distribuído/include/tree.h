#ifndef _TREE_H
#define _TREE_H /* Módulo gp_TREE */

#include "data.h"

struct tree_t; /* A definir pelo grupo em gp_TREE-private.h */

/* Função para criar uma nova árvore gp_TREE vazia.
...
/* Função que devolve um array de char* com a cópia de todas as datas da
 * árvore, colocando o último elemento do array com o valor NULL e
 * reservando toda a memória necessária. As datas devem vir ordenadas segundo a ordenação lexicográfica das mesmas.
 */
